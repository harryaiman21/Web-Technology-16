...
export default function UploadPage() {
  ...
  return (
    <div className="min-h-screen bg-background flex">
      <Navbar />
      <main className="flex-1 max-w-4xl mx-auto px-4 py-8 overflow-auto h-screen w-full">
        <Card>
          <CardHeader>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <input
                ...
                onChange={handleFile}
                className="block text-sm text-muted-foreground file:mr-4 file:py-2 file:px-4 file:rounded-none file:border-0 file:text-sm file:bg-red-500/10 file:text-red-200 hover:file:bg-red-500/20"
              />
            </div>
            <div className="space-y-2">
